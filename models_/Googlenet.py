...
class Inception(nn.Module):
    ...
    def forward(self,x):
        x1=self.ReLU(self.p1_1(x))
        x2=self.ReLU(self.p2_2(self.ReLU(self.p2_1(x))))
        x3=self.ReLU(self.p3_2(self.ReLU(self.p3_1(x))))
        x4=self.ReLU(self.p4_2(self.p4_1(x)))
