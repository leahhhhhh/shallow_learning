...
def train_model_process(model,train_loader,val_loader,test_loader,epochs):
    ...
    torch.save(best_model_wts,f"/Users/jiawen/Desktop/USYD_S2/5328/assignment2/pytorch_framework(alexnet)/best_model.pth")
...
if __name__ == "__main__":
    ...
    train_process,test_process=train_model_process(AlexNet,train_loader,val_loader,test_loader,4)
