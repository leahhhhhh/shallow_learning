...
if __name__=="__main__":
    model=Lenet()
    model.load_state_dict(torch.load('/Users/jiawen/Desktop/USYD_S2/5328/assignment2/pytorch_framework(lenet)/best_model.pth'))
    test_loader=test_data_process()
    ...
    with torch.no_grad():
        for b_x,b_y in test_loader:
            ...
            true_label=b_y.item()
            print('pre label',pre_label,"----------",'true label',true_label)
